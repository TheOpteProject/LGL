...
public class VertexStats {
	...
	public void setMin(Matrix m) {
		mins = m;
	}

	public void setMax(Matrix m) {
		maxs = m;
	}
	...
	public double span(int d) {
		return maxs.get(d, 0) - mins.get(d, 0);
	}
	...
	public double avg(int d) {
		return (totals.get(d, 0) / (double) vertexCtr);
	}
